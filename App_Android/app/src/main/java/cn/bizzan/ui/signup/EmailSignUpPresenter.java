...
public class EmailSignUpPresenter implements SignUpContract.EmailPresenter {
    ...
    @Override
    public void signUpByEmail(String email, String password,String tuijian2, String country, String challenge, String validate, String seccode) {
        view.displayLoadingPopup();
        dataRepository.signUpByEmail(email,  password, tuijian2,country,challenge,validate,seccode, new DataSource.DataCallback() {
            @Override
