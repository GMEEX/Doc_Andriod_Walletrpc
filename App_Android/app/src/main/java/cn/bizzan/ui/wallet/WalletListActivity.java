            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (type == 1){//充币
                    if (list.get(position).getCoin().getCanRecharge() == 0){
                        WonderfulToastUtils.showToast(WonderfulToastUtils.getString(R.string.notChargeMoneyTip));
                    }else {
                    ...
                    if (list.get(position).getCoin().getCanWithdraw() == 0){
                        WonderfulToastUtils.showToast(WonderfulToastUtils.getString(R.string.notMentionMoneyTip));
                    }else {
