...
public class RemoteDataSource implements DataSource {
    ...
    @Override
    public void signUpByEmail(String email, String password, String tuijian2, String country, String challenge, String validate, String seccode, final DataCallback dataCallback) {
        post().url(UrlFactory.getSignUpByEmail())
                ...
                .addParams("superPartner", "").build().execute(new StringCallback() {
            @Override
            public void onError(Request request, Exception e) {
                super.onError(request, e);
