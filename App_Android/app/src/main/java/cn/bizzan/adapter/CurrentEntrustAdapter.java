    ...
    protected void convert(BaseViewHolder helper, CurrentEntrust.ContentBean item) {
        ...
        if ("OPEN".equals(item.getEntrustType())) {
            if ("BUY".equals(item.getDirection())) {
                helper.setText(R.id.now_type, WonderfulToastUtils.getString(R.string.buyOpenmore)).setTextColor(R.id.now_type,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeGreen));
            } else {
                helper.setText(R.id.now_type, WonderfulToastUtils.getString(R.string.sellOpennull)).setTextColor(R.id.now_type,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeRed));
            }
        } else {
            if ("BUY".equals(item.getDirection())) {
                helper.setText(R.id.now_type, WonderfulToastUtils.getString(R.string.buyflatnull)).setTextColor(R.id.now_type,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeGreen));
            } else {
                helper.setText(R.id.now_type, WonderfulToastUtils.getString(R.string.sellflatmore)).setTextColor(R.id.now_type,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeRed));
            }
        }
        //撤单
        ...
        if (item.getType().equals("LIMIT_PRICE")) {
            helper.setText(R.id.now_one, WonderfulToastUtils.getString(R.string.text_limit_entrust));
        } else if (item.getType().equals("MARKET_PRICE")) {
            helper.setText(R.id.now_one, WonderfulToastUtils.getString(R.string.text_Market_entrust));
        } else {
            helper.setText(R.id.now_one, WonderfulToastUtils.getString(R.string.text_plan_entrust));
        }
        //触发价
        ...
        //委托数量
        helper.setText(R.id.now_six, (int)item.getVolume()+"张" );
