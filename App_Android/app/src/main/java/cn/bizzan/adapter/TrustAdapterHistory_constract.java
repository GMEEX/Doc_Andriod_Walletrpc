    ...
    protected void convert(final BaseViewHolder helper, EntrustHistory_constract.ContentBean item) {
        ...
        if ("OPEN".equals(item.getEntrustType())) {
            if ("BUY".equals(item.getDirection())) {
                helper.setText(R.id.trust_direction, WonderfulToastUtils.getString(R.string.buyOpenmore)).setTextColor(R.id.trust_direction,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeGreen));
            } else {
                helper.setText(R.id.trust_direction, WonderfulToastUtils.getString(R.string.sellOpennull)).setTextColor(R.id.trust_direction,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeRed));
            }
        } else {
            if ("BUY".equals(item.getDirection())) {
                helper.setText(R.id.trust_direction, WonderfulToastUtils.getString(R.string.buyflatnull)).setTextColor(R.id.trust_direction,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeGreen));
            } else {
                helper.setText(R.id.trust_direction, WonderfulToastUtils.getString(R.string.sellflatmore)).setTextColor(R.id.trust_direction,
                        ContextCompat.getColor(MyApplication.getApp(), R.color.typeRed));
            }
        }
        //时间
        ...
        //委托数量
        helper.setText(R.id.trust_one,(int) item.getVolume() + "张");
        //委托价
