...
//                .setText(R.id.tvCanUse, processPrice(new BigDecimal(item.getBalance())))
//                .setText(R.id.tv_suocang, processPrice(new BigDecimal(item.getToReleased())))
//                .setText(R.id.tvFrozon, processPrice(new BigDecimal(item.getFrozenBalance())))
